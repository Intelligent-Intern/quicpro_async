...
#ifndef QUICPRO_CONFIG_TLS_CRYPTO_INI_H
#define QUICPRO_CONFIG_TLS_CRYPTO_INI_H

/**
 * @brief Registers this module's php.ini entries with the Zend Engine.
 */
void qp_config_tls_and_crypto_ini_register(void);

/**
 * @brief Unregisters this module's php.ini entries from the Zend Engine.
 */
void qp_config_tls_and_crypto_ini_unregister(void);

#endif /* QUICPRO_CONFIG_TLS_CRYPTO_INI_H */
