/*
 * =========================================================================
 * FILENAME:   include/config/smart_dns/ini.h
 * PROJECT:    quicpro_async
 * AUTHOR:     Jochen Schultz <jschultz@php.net>
 *
 * WELCOME:    Small moves, Ellie. Small moves.
 *
 * PURPOSE:
 * This header file declares the internal C-API for handling the `php.ini`
 * entries of the Smart DNS configuration module.
 * =========================================================================
 */

#ifndef QUICPRO_CONFIG_SMART_DNS_INI_H
#define QUICPRO_CONFIG_SMART_DNS_INI_H
...
#endif /* QUICPRO_CONFIG_SMART_DNS_INI_H */
