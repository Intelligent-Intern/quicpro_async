 ...
 *
 * WELCOME:    The net is vast and infinite.
 *
 * PURPOSE:
 * This header file declares the public C-API for applying runtime
 * configuration changes from PHP userland to the application protocols module.
 * =========================================================================
 */

#ifndef QUICPRO_CONFIG_APP_PROTOCOLS_CONFIG_H
#define QUICPRO_CONFIG_APP_PROTOCOLS_CONFIG_H
...
#endif /* QUICPRO_CONFIG_APP_PROTOCOLS_CONFIG_H */
